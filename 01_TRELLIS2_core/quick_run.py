...
local = "c:/Users/LX/Documents/xwechat_files/wxid_bquybzk02pir22_89f0/temp/RWTemp/2026-07/059ecd6060ca0cb7ef3eafd7dd8d756c/e825a3c615dcdc0a89f9b49aab5efa72.jpg"
print("Uploading...")
sftp.put(local, '/root/TRELLIS.2/assets/example_image/scene_test.jpg')
...
img = Image.open("/root/TRELLIS.2/assets/example_image/scene_test.jpg").convert('RGB')
...
print(f"Done {time.time()-t0:.1f}s | Verts: {v.shape[0]:,} | Faces: {mesh.faces.shape[0]:,}")
...
out = "/root/TRELLIS.2/output_scene.glb"
glb.export(out, extension_webp=True)
print(f"-> output_scene.glb ({os.path.getsize(out)/1024**2:.1f} MB)")
'''

f = io.BytesIO(script.encode())
sftp.putfo(f, '/tmp/run_scene.py')
stdin, stdout, stderr = ssh.exec_command('python3 /tmp/run_scene.py', timeout=1200)
...
print("Downloading...")
sftp.get('/root/TRELLIS.2/output_scene.glb', 'E:/Python_Study/generate_3Dmodel/output_scene.glb')
print("Done -> output_scene.glb")
ssh.close()
